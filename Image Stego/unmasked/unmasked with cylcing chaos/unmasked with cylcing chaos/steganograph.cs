...
namespace unmasked_with_cylcing_chaos
{
    class steganograph
    {
        ...
        public int Convert_Binary_to_Int(int[] temp)
        {
            int col = 0; ;
        ...
        public void stegno2(int[,] image,ref int[]binary_image,ref int height,ref int width,ref int count)
        {
            restrict();
            int[] bits = new int[8];
            ...
            for (int kk = 0; kk < rand_sq2.Length; kk++)
            {
                ...
                if (kk == 0)
                {
                    ...
                    for (int ii = 0; ii < 33; ii++)
                    {
                        ...
                        if (ii==16)
                        {
                            height = Convert_Binary_to_Int(lengthbit);
                            count = 0;
                        }
                        if (ii == 32)
                        {
                            width = Convert_Binary_to_Int(lengthbit);
                            break;
                        }
                        if (context % 2 == 0)
                            lengthbit[count++] = 0;
                    ...
                    width = 512;
                    height = 512;
                    //binary_image = new int[8 * 3 * width * height];
                    binary_image = new int[8 * width * height];
                    count = 0;
                    for (int ii = 32; ii < rand_sq.Length; ii++)
                    {
                        ...
                        int context = image[rand_sq2[kk], index2];
                        if (context % 2 == 0)
                            binary_image[count++] = 0;
                        else
                            binary_image[count++] = 1;
        ...
        public void stegno(int[,] image,ref int[]binary_image,int dominator,ref int count)
        {
            restrict();
            int[] bits = new int[8];
            double Xnegative1 = xzero;
